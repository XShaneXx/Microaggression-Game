...
public class EndingButtons : MonoBehaviour
{
    ...
    public void disarm()
    {
        ...
        ShowEnding("Ending 1/5 - Disarm the Microaggression\n\n" +
                   "You calmly addresses the nurse's statement, pointing out that cultural practices can play a vital role in patient care. The nurse listens, and after a brief discussion, agrees to respect patient's diet while ensuring it aligns with medical guidelines.");
    }
    ...
    public void educate()
    {
        ...
        ShowEnding("Ending 2/5 - Educate the Offender\n\n" +
                   "You takes a moment to explain why dismissing cultural diets can be harmful, not just to patient but to the broader goal of providing culturally competent care. The nurse acknowledges her mistake, and the conversation leads to a better understanding of cultural sensitivity.");
    }
    ...
    public void seek()
    {
        ...
        ShowEnding("Ending 3/5 - Seek External Intervention\n\n" +
                   "Recognizing the complexity of the situation, you decides to involve the hospital's cultural liaison. The liaison mediates the discussion, helping both you and the nurse to reach a solution that respects patient's cultural practices while ensuring his medical needs are met.");
    }
    ...
    public void make()
    {
        ...
        ShowEnding("Ending 4/5 - Make the Invisible Visible\n\n" +
                   "You point out the underlying assumptions in the nurse's comments, bringing to light the importance of respecting diverse cultural practices. This discussion helps the team to see the value in integrating these practices into patient care, fostering a more inclusive environment.");
    }
    ...
    public void wrongchoice()
    {
        ...
        ShowEnding("Ending 5/5 - You didn't help out Mr. Khan.\n\n" +
                   "Unfortunately, by not addressing the microaggression, the situation worsens. The patient feels disrespected, leading to further complications in his care. The team later reflects on the missed opportunity to intervene.");
    }
